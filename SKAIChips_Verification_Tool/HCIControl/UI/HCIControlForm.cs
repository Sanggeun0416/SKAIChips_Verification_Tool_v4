...
namespace SKAIChips_Verification_Tool.HCIControl
{
    public partial class HCIControlForm : Form
    {
        ...
        Command SelectedHciCommand = null;
        Parameter SelectedHciParameter = null;
        ...
        private CommandGroup CurHciCmdGroup;
        private Command CurHciCommand;
        private Parameter CurHciParameter;
        ...
        private void SetParameter(Parameter Para)
        {
        ...
        private List<Command> HCIScript = new List<Command>();
        private int HciScrCommandIndex = -1;
        private int HciScrParameterIndex = -1;
        private Command HciScrCommand;
        private Parameter HciScrParameter;
        ...
        private void AddScriptFromCurHciCommand()
        {
            if (CurHciCommand != null)
            {
                Command Cmd = CurHciCommand.Clone();
                HCIScript.Add(Cmd);
        ...
        {
            foreach (Command Cmd in HCIScript)
            {
                Cmd.Send();
            }
        }
